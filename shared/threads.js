(function(){
  function createThreads(container, opts) {
    const options = Object.assign({ color:[1,1,1], amplitude:1, distance:0, enableMouseInteraction:true }, opts||{});
...
`;
    ...
    const program = new OGL.Program(gl, {
      ...
      uniforms: {
        ...
        uColor: { value: new OGL.Color(options.color[0], options.color[1], options.color[2]) },
    ...
    function resize(){
      ...
      program.uniforms.iResolution.value.r = cw;
      program.uniforms.iResolution.value.g = ch;
      program.uniforms.iResolution.value.b = cw / ch;
    }
    ...
    function update(t){
      ...
      program.uniforms.iTime.value = (t||0) * 0.001;
  ...
  window.ThreadsEffect = { init: createThreads };
})();
